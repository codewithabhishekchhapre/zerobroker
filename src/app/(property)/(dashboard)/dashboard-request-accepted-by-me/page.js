...
export const metadata = {
  title: "Dashboard Request Accepted by Me || ZeroBroker - Real Estate NextJS Template",
};

const DashboardRequestAcceptedByMe = () => {
  return (
    <>
      {/* Main Header Nav */}
      <DashboardHeader />
              ...
              <div className="row align-items-center pb40">
                <div className="">
                  <div className="dashboard_title_area">
                    <h2>Requests Accepted By You</h2>
...
export default DashboardRequestAcceptedByMe;
